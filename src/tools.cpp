...
/**
* Return string representation of Evolution address
*/
string
...
{
    // default path to evolution folder
    // on linux this is /home/<username>/.evolution
    string default_evolution_dir = tools::get_default_data_dir();

    if (nettype == cryptonote::network_type::TESTNET)
        default_evolution_dir += "/testnet";
    if (nettype == cryptonote::network_type::STAGENET)
        default_evolution_dir += "/stagenet";


    // the default folder of the lmdb blockchain database
    // is therefore as follows
    return default_evolution_dir + string("/lmdb");
}
